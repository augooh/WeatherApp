...
public class FragmentNavigator extends Navigator<FragmentNavigator.Destination> {
    ...
    private static final String KEY_BACK_STACK_IDS = "anndroidx-nav-fragment:navigator:backStackIds";
    ...
    @NonNull
    @Override
    public Destination createDestination() { return new Destination(this);}

    @Deprecated
    @NonNull
    public Fragment instantiateFragment(@NonNull Context context,
                                        @NonNull FragmentManeger fragmentManager,
